...
export default function HomePage() {
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <ModeToggle />
      <div className="p-2 py-5 flex flex-col items-center gap-2 w-full sm:w-[40%] justify-center text-center border-x-2 border-primary/20 rounded-lg text-balance">
